...
Веб-приложение (Демо версия): [Прогностическая модель рассеяннго склероза по МРТ снимкам. РАБОЧАЯ ССЫЛКА](https://huggingface.co/spaces/dmitry212010/sclerosis_streamlit)
